...
<div class="container">   
    <div class="selec_filter">
     <form action="tabla.php" method="POST"  class="form">
    ...
    <p class="titulo_p">Entrada SVCS</p>
    <?php if(empty($_POST['valor'])){
        echo "<a href='excel.php' class='descarga_doc'><i class='fas fa-x2 fa-file-download'></i> Descarga</a>" ;
              ...
              <table >
                ...
                private $indice;
                function _constructor($nPorPagina){
                    parent::_constructor();
                ...
                function calcularPaginas(){
                    $query = $this->conect()->query('SELECT count(*) AS total FROM `entrada_fc');
...
if(is_numeric($_GET['pagina'])){
                     ...
                     $this->indice = ($this->paginaActal-1) * ($this->resultadoPorPagina);
                    }
                }
