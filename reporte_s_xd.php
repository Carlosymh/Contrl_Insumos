...
<head>
    ...
    <title>Reportes Salida XD</title>
...
<div class="container">   
    <div class="selec_filter">
     <form action="reporte_s_xd.php" method="POST"  class="form">
    <select name="filtro" id="filtro" class="form-filter" >
        ...
        <option value="	Gaylord_Enviados">Bultos</option>        
    ...
    <p class="titulo_p">Salida XD</p>
    <?php if(empty($_POST['valor'])){
        echo "<a href='cvs_s_xd.php' class='descarga_doc'><i class='fas fa-x2 fa-file-download'></i> Descarga</a>" ;
               }else{
                  $filtro=$_POST['filtro'];
                $valor=$_POST['valor'];
                echo '<a href="cvs_s_xd.php?filtro='.$filtro.'&valor='.$valor.'" class="descarga_doc"><i class="fas fa-x2 fa-file-download"></i> Descarga</a>';
              }   ?> </div>
              <table >
                 <tr>
                <th>ID </th>
