...
$sql="INSERT INTO `entrada_xd` ( Centro_de_trabajo_donde_te_encuentras, Total_tarimas, Tarima_en_buen_estado, Tarimas_en_mal_estado, Total_Gaylors, Gaylors_en_buen_estado, Gaylors_en_mal_estado, Service_Center, Destino_Proveniente, Responsable, Fecha_Creación) VALUES ('$cdtdte','$Total_tarimas','$Tarima_en_buen_estado','$Tarimas_en_mal_estado','$Total_Gaylors','$Gaylors_en_buen_estado','$Gaylors_en_mal_estado','$Service_Center','$Destino_Proveniente','$Responsable_Registro','$date')";
