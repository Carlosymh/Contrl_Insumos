...
<head>
    ...
    <title>Reportes Salida FC</title>
...
<div class="container">   
    <div class="selec_filter">
     <form action="reporte_s_fc.php" method="POST"  class="form">
    ...
    <p class="titulo_p">Salida FC</p>
    <?php if(empty($_POST['valor'])){
        echo "<a href='cvs_s_fc.php' class='descarga_doc'><i class='fas fa-x2 fa-file-download'></i> Descarga</a>" ;
               }else{
                  $filtro=$_POST['filtro'];
                $valor=$_POST['valor'];
                echo '<a href="cvs_s_fc.php?filtro='.$filtro.'&valor='.$valor.'" class="descarga_doc"><i class="fas fa-x2 fa-file-download"></i> Descarga</a>';
              }   ?> </div>
              <table >
                 <tr>
                <th>ID </th>
